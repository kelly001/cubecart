<form action="{$VAL_SELF}" method="post" enctype="multipart/form-data">
    <div id="ZPayment" class="tab_content">
        ...
        <fieldset>
            ...
            <div><label for="merchant_key">{$LANG.zpayment.merchant} MK*</label><span><input name="module[merchant_key]" id="merchant_key" class="textbox" type="text" value="{$MODULE.merchant_key}" /></span></div>
            <div><label for="init_pass">{$LANG.zpayment.pass}PASS</label><span><input name="module[init_pass]" id="init_pass" class="textbox" type="text" value="{$MODULE.init_pass}" /></span></div>
            <div><label for="settings">{$LANG.zpayment.settings}</label><span><input name="module[settings]" id="settings" class="textbox" type="text" value="{$MODULE.settings}" /></span></div>
